...
import { LayoutDashboard, FileText, Wrench, MessageSquare, Settings, Home, LogOut, ChevronRight } from "lucide-react"
        ...
        <div className="flex items-center flex-shrink-0 px-4 mb-8">
          <Link href="/" className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h2 className="text-xl font-bold text-gray-900 truncate">Perfect Ceiling</h2>
              <p className="text-sm text-purple-600 font-medium truncate">Admin Panel</p>
            </div>
          </Link>
        </div>
